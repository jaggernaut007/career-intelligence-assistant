...
|----------|-----------|-----------|
| **code-reviewer** | Context7, Nexus-MCP, Snyk | Verify API usage, check callers/callees/impact, scan security |
| **research-assistant** | Context7, Sequential Thinking, Snyk, Nexus-MCP | Docs lookup, structured reasoning, dependency safety, code search |
